...
class ChessPiece {
   ...
   * @param target_col An integer representing the col of the target position on the board.
   ...
   */
   virtual bool canMove(const int& target_row,const int& target_col, const std::vector<std::vector<ChessPiece*>>& board) = 0;
};